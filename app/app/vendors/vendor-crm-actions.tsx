...
import { recordVendorCommunication } from "@/lib/actions/vendor-communications";
...
export function VendorCrmActions({ vendorId, phone, email, projectIds }: Props) {
  ...
  function run(action: CrmAction) {
    ...
    formData.set("returnTo", "/app/vendors");
    for (const projectId of projectIds) {
      formData.append("projectIds", projectId);
    }

    startTransition(async () => {
      await recordVendorCommunication(formData);
